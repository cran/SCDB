...
```{r benchmark_preprocessing, echo = FALSE, eval = rlang::is_installed("here")}
...
```{r benchmark_1, echo = FALSE, eval = rlang::is_installed("here")}
...
```{r benchmark_2, echo = FALSE, eval = rlang::is_installed("here")}
