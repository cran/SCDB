...
```{r setup, echo = FALSE, results = "hide", eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r example_data_hidden, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r example_1, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r example_2, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r example_2_results_a, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r delta_1_export, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r delta_1_load, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
delta_load(
  conn = conn_secondary,
...
```{r example_3, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
data <- head(example_data, 5) %>%
...
```{r example_4, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r example_4_results_a, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
get_table(conn_primary, "mtcars", slice_ts = NULL)
```

And again, we want to replay both of these changes in the secondary database.
```{r delta_2_export, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
```{r delta_2_load, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
delta_load(
  conn = conn_secondary,
  db_table = "mtcars_firewalled",
  delta = delta_2
...
```{r delta_batch_export, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
...
We then use `delta_load()` to apply these changes in the secondary database.
```{r delta_batch_load, eval = rlang::is_installed("duckdb") && R.version$major >= "4"}
delta_load(
  conn = conn_secondary,
